        ...
        <Box className="modal-post">
          <form onSubmit={onSubmit}>
            ...
            <TextField
              ...
              variant="outlined"
              name="titulo"
              error={postagem.titulo.length < 5 && postagem.titulo.length > 0}
              helperText={
                postagem.titulo.length < 5 && postagem.titulo.length > 0
            ...
            <TextField
              ...
              error={postagem.texto.length < 10 && postagem.texto.length > 0}
              helperText={
                postagem.texto.length < 10 && postagem.texto.length > 0
                  ? "O texto deve conter pelo menos 10 caracteres"
                  : ""
              }
              id="texto"
              label="texto"
